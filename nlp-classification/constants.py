...
DROOT = njoin('/project/frac_attn/fractional-attn/fnsformer-module-default-trainer', '.droot')
...
MODEL_NAMES = ['fnsformer', 'v2fnsformer', 'dpformer', 'l2former']  # model str names
NAMES_DICT = {'fnsformer': 'FNSFormer', 'v2fnsformer': 'FNSFormer', 'dpformer': 'Transformer',
