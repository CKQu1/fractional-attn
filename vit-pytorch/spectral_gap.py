...
if __name__ == '__main__':
    ...
    for model_idx, model_dir in enumerate(model_dirs):        
        ...
        axss[lidx][ax_idx].scatter(np.arange(1,len(eigvals)+1), eigvals,
                                   c=c_hyp, alpha=1, s=4)
    ...
    for lidx in range(config['num_hidden_layers']):
        ...
        # ----- FIG LABELS -----
        # col labels
        titles = ['Attention matrix', 'Eigenvalues 1', 'Eigenvalues 2']
