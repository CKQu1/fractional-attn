...
GADI_SOURCE_2 = '/scratch/uu69/cq5024/myenvs/nmt/bin/activate'
# -------------------
...
NAMES_DICT.update({'cifar10': 'CIFAR10', 'mnist': 'MNIST',
...
LINESTYLE_DICT = {'spfns'+MODEL_SUFFIX: 'solid', 'spopfns'+MODEL_SUFFIX: 'solid',  # (0,(5,1))               
                  'rdfns'+MODEL_SUFFIX: 'solid', 'oprdfns'+MODEL_SUFFIX: 'solid',
